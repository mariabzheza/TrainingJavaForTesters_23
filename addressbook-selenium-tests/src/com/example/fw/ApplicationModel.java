...
public class ApplicationModel {
	...
	public void setGroups(List<GroupData> groups) {
		// тут мы берём параметр groups, клонируем и помещаем результат в поле this.groups; теперь его уже никто не испортит 
		this.groups = new SortedListOf<GroupData> (groups);
	}
	
	public void setContacts(List<ContactData> contacts) {
		// тут мы берём параметр contacts, клонируем и помещаем результат в поле this.contacts; теперь его уже никто не испортит 
